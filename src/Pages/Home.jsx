  ...
  return (
    <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${background})` }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white mt-10">
        ...
        <button onClick={handleShowRecipes} className="px-6 py-3 text-white font-semibold transition duration-300 bg-[rgb(228,89,0)] text-lg rounded-xl inline-flex items-center focus:outline-none hover:bg-[#C24000]">
