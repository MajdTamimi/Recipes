  ...
  return (
    <div className="w-1/4 rounded-lg shadow-2xl relative min-h-100">
      ...
      <div className="flex-col mx-2 pb-3 pt-3">
        ...
        <button
          onClick={handleShowDetails} className="bg-[rgb(228,89,0)] text-white font-semibold text-base py-2 px-4 rounded-xl inline-flex items-center absolute right-4 bottom-4 focus:outline-none hover:bg-[#C24000]">
